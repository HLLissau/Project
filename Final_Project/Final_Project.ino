...
// interpolation of zero-crossing
    ...
    //crossingCounter = # of zero crossings in the input wave
    //sample counter = # of samples in the considered time interval
    //measuredSampleRate = 10.923 interupts generated by timer5 when timer5 is set to 10.000, as found in experiment
